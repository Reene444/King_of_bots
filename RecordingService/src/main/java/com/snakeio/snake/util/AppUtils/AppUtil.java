package com.snakeio.snake.util.AppUtils;
...
public class AppUtil {
    ...
    public static String get_photo_upload_path(String fileName,String folder_name,String userId)throws IOException{
        String path=PATH+userId+"/"+folder_name;
