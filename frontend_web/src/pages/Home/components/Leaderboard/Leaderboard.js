...
const Leaderboard = ({ leaderboard,score,onReturnRoom }) => {
    const uniquePlayers = [...leaderboard]
        ...
        .slice(0, 5);
    const current_player=useSelector(state=>state.game.current_player)
    const current_player_id=current_player===null?0:current_player.id
    return (
                ...
                <CardContent>
                    ...
                    {uniquePlayers.map((player, index) => (
                        <li
                            ...
                            style={{ backgroundColor: player.id === current_player_id ? 'red' : 'transparent' }}
                        >
