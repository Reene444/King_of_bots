...
public class SeedData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        Room room1= new Room("1",null,1000,10);
        Room room2= new Room("2",null,1000,10);
        Room room3= new Room("3",null,1000,10);
        Room room4= new Room("4",null,1000,10);
        Room room5= new Room("5",null,1000,10);
        Room room6= new Room("6",null,1000,10);
        Room room7= new Room("7",null,1000,10);
        Room room8= new Room("8",null,1000,10);
        Room room9= new Room("9",null,1000,10);
        Room room10= new Room("10",null,1000,10);
        Room room11= new Room("11",null,1000,10);
        Room room12= new Room("12",null,1000,10);
        Room room13= new Room("13",null,1000,10);
        Room room14= new Room("14",null,1000,10);
        Room room15= new Room("15",null,1000,10);
        Room room16= new Room("16",null,1000,10);
        Room room17= new Room("17",null,1000,10);
        Room room18= new Room("18",null,1000,10);
